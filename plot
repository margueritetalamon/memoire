...
plot_traj_mu <- function(sim_gibbs){
  plot(sim_gibbs$mu[,1],type='l',col='royalblue4',main='',xlab='nombre d\'itérations',ylim=c(-7,10),ylab=expression(mu[j]),lwd=2)
  lines(sim_gibbs$mu[,2],type='l',col='springgreen3')
